...
router.get("/", verifyFirebaseToken as any, getSmallContentRateLimiter, getAllMyBlogsController as any);
router.post(
	"/",
...
router.delete("/:id", verifyFirebaseToken as any, deleteSmallRateLimiter, deleteBlogController as any);
router.patch("/:id/save", verifyFirebaseToken as any, updateSmallRateLimiter, saveBlogController as any);
router.patch("/:id/unsave", verifyFirebaseToken as any, updateSmallRateLimiter, unsaveBlogController as any);

...
import { forumReplies, forumReplyMedias, users, forumReplyLikes } from "@/db/schema.js";

export const getAllRepliesForAComment = async (id: string, userId: number, page: number = 1) => {

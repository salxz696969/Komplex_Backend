...
import { videoComments, videoCommentMedias, videoCommentLike, videoReplies, users } from "@/db/schema.js";
import { and, desc, eq, inArray, sql } from "drizzle-orm";
import { deleteFromCloudflare } from "@/db/cloudflare/cloudflareFunction.js";
import { redis } from "@/db/redis/redisConfig.js";

export const getAllVideoCommentsForAVideo = async (id: string, userId: number, page: number = 1) => {
